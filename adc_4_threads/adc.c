...
void * pthread2_start_routine(void * arg)
{
   /* Idling */
   while(1);
}
void * pthread3_start_routine(void * arg)
{
   /* Idling */
   while(1);
}
int main(int argc, char *argv[])
{
   ...
   */
   ...
   pthread_create(&tid2, NULL, pthread2_start_routine, NULL);
   pthread_create(&tid3, NULL, pthread3_start_routine, NULL);
